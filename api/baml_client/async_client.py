...
class BamlAsyncClient:
    ...
    async def GeneraDietaSettimanale(self, dataInizio: str,giornoInizio: str,dataFine: str,giornoFine: str,peso: float,altezza: float,eta: typing.Optional[int],sesso: typing.Optional[str],obiettivo: str,altri_dati: str,
    ...
    async def ModificaDietaSettimanale(self, dietaCorrente: types.DietaSettimanale,richiestaModifica: str,peso: float,altezza: float,eta: typing.Optional[int],sesso: typing.Optional[str],obiettivo: str,oggiData: str,oggiGiorno: str,
        baml_options: BamlCallOptions = {},
    ) -> types.DietaSettimanale:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
